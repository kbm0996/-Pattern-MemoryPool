...
#ifdef __LF_QUEUE__
mylib::CLFQueue<st_TEST_DATA*> *g_pQueue;
#endif
...
void main()
{
	g_pMemPool = new mylib::CLFMemoryPool<st_TEST_DATA>(0);
#ifdef __LF_QUEUE__
	g_pQueue = new mylib::CLFQueue<st_TEST_DATA*>();
#endif
